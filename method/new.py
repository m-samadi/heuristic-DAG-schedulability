...
# The main function #
def execute(num_tasks, num_tasksets, num_threads, task_list, period, deadline, alloc_alg, disp_alg, graphic_result, dot_file_path, yaml_file_path):
	...
	func.write_yaml(period, deadline, num_tasks, task_list, num_tasksets, num_threads, exec_queue, dot_file_path, yaml_file_path)
